...
##############################
def MirrorInfo(StoryAnswer, LiveAnswer, Data, Archive):
	UserName = Data["graphql"]["user"]["username"]
	ArchiveName = Archive["graphql"]["Archive"]["ArchiveName"]
	#### SURE FACE DATA ####
	print (f"{Y}INFO :{W}\n			{G}True{W} >>>>> Yes.\n			{G}False{W} >>>>> No.\n")
	print ("= "*25)
	...
	HasArchive(Archive=["graphql"]["archive"], UserName=Archivename)
	...
	HasOwnArchive(Archive, ArchiveName)
